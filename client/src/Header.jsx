...
export default function Header() {
    ...
    return (
        <header className="flex justify-between">
            ...
            <span className='font-bold text-xl'>BookThatDrive</span>
            </Link>
            ...
            <div className="flex items-center gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300">
                ...
                <div className="border-l border-gray-300 h-6"></div>
                <div>Add guests</div>
            <button className="primary bg-[#F5385D] text-white p-1 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                </svg>
            </button>
            </div>
            <Link to={user ? '/account' : '/login'} className='flex items-center gap-3 border border-gray-300 rounded-full py-2 px-4 relative '>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                    <path strokeLinecap="r  ound" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                </svg>
