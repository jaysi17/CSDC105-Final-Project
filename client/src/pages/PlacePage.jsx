...
export default function PlacePage() {
        ...
        return (
            <div className="absolute inset-0 bg-black text-white min-h-screen">
                <div className="bg-black p-8 grid gap-4">
                    <div>
                        <h2 className="text-3xl text-white mr-36">Photos of {place.title} </h2>
                        <button onClick={() => setShowAllPhotos(false)} className="cursor-pointer fixed right-8 top-8 flex gap-2 py-2 px-4 rounded-2xl shadow shadow-black bg-white text-black"> 
    ...
    return(
        <div className="mt-4 bg-gray-100 -mx-8 px-8 pt-8">
            ...
            <a className="flex gap-1 my-2 underline font-bold" target="_blank" href={'https://maps.google.com/?q='+place.address}>
       ...
       place.photos[2] : `http://localhost:4000/uploads/${place.photos[2]}`} alt="" />
                ...
                <button onClick={() => setShowAllPhotos(true)} className="cursor-pointer flex gap-1 absolute bottom-2 right-2 py-2 px-4 bg-white rounded-2xl shadow shadow-gray-500">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
